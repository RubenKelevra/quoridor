...
Friend Class clsBoard
	...
	Function checkMove(ByRef pos As CustomTypes.Position, ByVal dir_Renamed As Byte) As Boolean
		...
		'UPGRADE_WARNING: Arrays in Struktur newPos müssen möglicherweise initialisiert werden, bevor sie verwendet werden können. Klicken Sie hier für weitere Informationen: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"'
...
fEnd: 
	...
	Function getPlayerLocation(ByRef i As Byte) As CustomTypes.Position
		...
		'UPGRADE_WARNING: Die Standardeigenschaft des Objekts getPlayerLocation konnte nicht aufgelöst werden. Klicken Sie hier für weitere Informationen: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
OutOfIndex: 
	...
	Private Function getPlayerMove() As CustomTypes.Move
		...
		'UPGRADE_WARNING: Die Standardeigenschaft des Objekts getPlayerMove konnte nicht aufgelöst werden. Klicken Sie hier für weitere Informationen: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		getPlayerMove = Players(activePlayer).getMove
	End Function
	
	Sub doPlayerMove()
		'UPGRADE_WARNING: Arrays in Struktur PlayerMove müssen möglicherweise initialisiert werden, bevor sie verwendet werden können. Klicken Sie hier für weitere Informationen: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"'
		Dim PlayerMove As CustomTypes.Move
		If getPlayerType(activePlayer) = 1 Then 'player is AI controlled
			'UPGRADE_WARNING: Die Standardeigenschaft des Objekts PlayerMove konnte nicht aufgelöst werden. Klicken Sie hier für weitere Informationen: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
returnFalse_checkPlaceWall: 
	...
	Function checkPlaceWall_donotuse(ByRef newPos As CustomTypes.Brick) As Boolean
		...
		'UPGRADE_WARNING: Arrays in Struktur startPoint müssen möglicherweise initialisiert werden, bevor sie verwendet werden können. Klicken Sie hier für weitere Informationen: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="814DF224-76BD-4BB4-BFFB-EA359CB9FC48"'
